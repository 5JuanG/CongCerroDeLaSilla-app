        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4" onClick={onClose}>
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md" onClick={e => e.stopPropagation()}>
                <div className="p-4 border-b">
                    <h3 className="text-xl font-bold text-gray-800">Compartir Asignación</h3>
                </div>
                <div className="p-6 bg-gray-100">
                    <div ref={contentRef} className="bg-[#E0FDCF] p-4 rounded-xl shadow-sm relative" style={{'--tail-bg': '#E0FDCF'} as React.CSSProperties}>
...
const AsignacionesReunion: React.FC<AsignacionesReunionProps> = ({
    ...
    return (
        <div className="container mx-auto max-w-7xl">
            {shareModalContent && <ShareModal content={shareModalContent} onClose={() => setShareModalContent(null)} />}
